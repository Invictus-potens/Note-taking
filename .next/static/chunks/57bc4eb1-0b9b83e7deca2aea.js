"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[874],{3671:function(e,t,r){r.d(t,{C:function(){return signOut},a9:function(){return createUserWithEmailAndPassword},aa:function(){return signInWithEmailAndPassword},aj:function(){return updateProfile},o:function(){return getAuth},y:function(){return onAuthStateChanged}});var i=r(8745),n=r(3991),s=r(6914),a=r(44),o=r(5538);function _prodErrorMap(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let l=_prodErrorMap,c=new i.LL("auth","Firebase",_prodErrorMap()),u=new s.Yd("@firebase/auth");function _logWarn(e,...t){u.logLevel<=s.in.WARN&&u.warn(`Auth (${n.Jn}): ${e}`,...t)}function _logError(e,...t){u.logLevel<=s.in.ERROR&&u.error(`Auth (${n.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function updateProfile(e,{displayName:t,photoURL:r}){if(void 0===t&&void 0===r)return;let n=(0,i.m9)(e),s=await n.getIdToken(),a=await _logoutIfInvalidated(n,updateProfile$1(n.auth,{idToken:s,displayName:t,photoUrl:r,returnSecureToken:!0}));n.displayName=a.displayName||null,n.photoURL=a.photoUrl||null;let o=n.providerData.find(({providerId:e})=>"password"===e);o&&(o.displayName=n.displayName,o.photoURL=n.photoURL),await n._updateTokensIfNecessary(a)}function onIdTokenChanged(e,t,r,n){return(0,i.m9)(e).onIdTokenChanged(t,r,n)}function beforeAuthStateChanged(e,t,r){return(0,i.m9)(e).beforeAuthStateChanged(t,r)}function onAuthStateChanged(e,t,r,n){return(0,i.m9)(e).onAuthStateChanged(t,r,n)}function signOut(e){return(0,i.m9)(e).signOut()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
